    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        public virtual async Task SetCurrentCustomerAsync(Customer customer = null)
        {
            if (customer == null)
            {
                ...
                if ((!isSearchEngine && customer != null) || (customer == null || customer.Deleted || !customer.Active || customer.RequireReLogin))
                {
                    //try to get registered user
                    var authCustomer = await _authenticationService.GetAuthenticatedCustomerAsync();
