...
namespace Nop.Services.ExportImport.Help
{
    ...
    public class PropertyManager<T>
    {
        ...
        public PropertyManager(IEnumerable<PropertyByName<T>> properties, CommonSettings commonSettings)
        {
        ...
        public virtual async Task WriteToXlsxAsync(IXLWorksheet worksheet, int row, int cellOffset = 0, IXLWorksheet fWorksheet = null)
        {
            ...
            foreach (var prop in _properties.Values)
            {
                ...
                if (prop.IsDropDownCell && _commonSettings.ExportImportRelatedEntitiesByName)
                {
        ...
        /// </summary>
        public bool UseDropdownLists => _commonSettings.ExportImportUseDropdownlistsForAssociatedEntities && _commonSettings.ExportImportRelatedEntitiesByName;
    }
}
