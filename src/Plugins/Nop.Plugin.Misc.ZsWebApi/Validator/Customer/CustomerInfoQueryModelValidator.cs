...
{
    public partial class CustomerInfoQueryModelValidator : BaseNopValidator<CustomerInfoQueryModel>
    {
        public CustomerInfoQueryModelValidator(ILocalizationService localizationService,
