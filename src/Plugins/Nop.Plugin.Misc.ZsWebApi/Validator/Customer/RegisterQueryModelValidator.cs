...
{
    public partial class RegisterQueryModelValidator : BaseNopValidator<RegisterQueryModel>
    {
        public RegisterQueryModelValidator(ILocalizationService localizationService,
